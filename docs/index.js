...
(function($PS) {
  ...
  var component = (function () {
      var updateLocalStorage = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 188, column 5 - line 193, column 60): " + [ v.m_storage.constructor.name ]);
      });
  ...
  var selectButton = function (itemId) {
          ...
          var itemRow = function (itemId) {
              var selectToggleButton = (function () {
                  var v1 = Data_Map_Internal.lookup(Data_Ord.ordInt)(itemId)(v.selectedItems);
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return selectButton(itemId);
                  };
                  if (v1 instanceof Data_Maybe.Just) {
                      return deselectButton(itemId);
                  };
                  throw new Error("Failed pattern match at Main (line 125, column 12 - line 127, column 46): " + [ v1.constructor.name ]);
              })();
              var itemText = Data_Maybe.maybe("")(Control_Category.identity(Control_Category.categoryFn))(Data_Map_Internal.lookup(Data_Ord.ordInt)(itemId)(v.items));
              return Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ itemInput(itemText)(UpdateItem.create(itemId)), selectToggleButton ]) ]);
          };
          var selectedRow = function (itemId) {
              var selectedItemControls = (function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 135, column 12 - line 140, column 18): " + [ v1.constructor.name ]);
              })();
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Storage_Storage.getItem("items")(v.m_storage.value0)))(function (m_itemsS) {
                  ...
                  if (m_items instanceof Data_Maybe.Just) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $40.items = m_items.value0.items;
                          $40.items_order = m_items.value0.items_order;
                          return $40;
                      });
                  };
                  throw new Error("Failed pattern match at Main (line 203, column 9 - line 206, column 73): " + [ m_items.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at Main (line 197, column 5 - line 212, column 33): " + [ v.m_storage.constructor.name ]);
      });
      var handleAction = function (v) {
          if (v instanceof Init) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.localStorage)))(function (storage) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $49.m_storage = new Data_Maybe.Just(storage);
                      return $49;
                  }))(function () {
          ...
          if (v instanceof AddItem) {
              var addItem = function (v1) {
                  ...
                  var items_order$prime = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ newItemId ])(v1.items_order);
                  ...
                  $53.items = items$prime;
                  $53.items_order = items_order$prime;
                  return $53;
              };
          ...
          if (v instanceof DeleteItem) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $58.items = Data_Map_Internal["delete"](Data_Ord.ordInt)(v.value0)(s.items);
                  return $58;
              }))(function () {
          ...
          if (v instanceof UpdateSelected) {
              ...
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $67.selectedItems = updateItem(s.selectedItems);
                  return $67;
              });
          };
          if (v instanceof SelectItem) {
              var selectItem = function (v1) {
                  ...
                  throw new Error("Failed pattern match at Main (line 179, column 9 - line 181, column 35): " + [ v2.constructor.name ]);
              };
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  var $77 = {};
                  for (var $78 in s) {
          ...
          if (v instanceof DeselectItem) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $81.selectedItems = Data_Map_Internal["delete"](Data_Ord.ordInt)(v.value0)(s.selectedItems);
                  return $81;
              });
          };
          throw new Error("Failed pattern match at Main (line 142, column 18 - line 184, column 80): " + [ v.constructor.name ]);
      };
