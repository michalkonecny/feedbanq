...
(function($PS) {
  ...
  var StartMovingItem = (function () {
      function StartMovingItem(value0) {
          this.value0 = value0;
      };
      StartMovingItem.create = function (value0) {
          return new StartMovingItem(value0);
      };
      return StartMovingItem;
  })();
  var ProcessKey = (function () {
      function ProcessKey(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ProcessKey.create = function (value0) {
          return function (value1) {
              return new ProcessKey(value0, value1);
          };
      };
      return ProcessKey;
  })();
  var UpdateItem = (function () {
      function UpdateItem(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdateItem.create = function (value0) {
          return function (value1) {
              return new UpdateItem(value0, value1);
          };
      };
      return UpdateItem;
  })();
  var DeleteAllItems = (function () {
      ...
      DeleteAllItems.value = new DeleteAllItems();
  ...
  var DeselectItem = (function () {
      function DeselectItem(value0) {
          this.value0 = value0;
      };
      DeselectItem.create = function (value0) {
          return new DeselectItem(value0);
      };
      return DeselectItem;
  })();
  var UpdateSelected = (function () {
      function UpdateSelected(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdateSelected.create = function (value0) {
          return function (value1) {
              return new UpdateSelected(value0, value1);
          };
      };
      return UpdateSelected;
  })();
  var subscribeToKeys = function (dictMonadAff) {
      return function (keyAction) {
          var keyHandler = function (sid) {
              return function (ev) {
                  return keyAction(sid)(Web_UIEvent_KeyboardEvent.key(ev));
              };
          };
  ...
  var initialState = {
      items: Data_Map_Internal.empty,
      items_order: [  ],
      m_backup: Data_Maybe.Nothing.value,
      selectedItems: Data_Map_Internal.empty,
      m_storage: Data_Maybe.Nothing.value,
      m_movingItemIx: Data_Maybe.Nothing.value
  };
  var component = (function () {
      var updateLocalStorage = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          var jsonS = Data_Argonaut_Core.stringify(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeMap(Data_Ord.ordInt)(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.encodeJsonJString))(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonArray(Data_Argonaut_Encode_Class.encodeJsonInt))(Data_Argonaut_Encode_Class.gEncodeJsonNil)({
          ...
          if (v.m_storage instanceof Data_Maybe.Just) {
              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(function __do() {
                  Effect_Console.log("updateLocalStorage: jsonS = " + jsonS)();
                  return Web_Storage_Storage.setItem("items")(jsonS)(v.m_storage.value0)();
              });
          };
          throw new Error("Failed pattern match at Main (line 279, column 5 - line 284, column 42): " + [ v.m_storage.constructor.name ]);
      });
      var render = function (v) {
          var undoButton = Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title("UNDO"), Halogen_HTML_Events.onClick(function (v1) {
              return Undo.value;
          }) ])([ Halogen_HTML_Core.text("UNDO") ]);
          var selectButton = function (itemId) {
              return Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title("select"), Halogen_HTML_Events.onClick(function (v1) {
                  return new SelectItem(itemId);
              }) ])([ Halogen_HTML_Core.text("select") ]);
          };
          var result = (function () {
              var selectedItemsTexts = (function () {
                  var pickSelected = Data_Function.flip(Data_Map_Internal.lookup(Data_Ord.ordInt))(v.selectedItems);
                  return Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)(pickSelected)(v.items_order));
              })();
              var text = Data_String_Common.joinWith("<br/>")(selectedItemsTexts);
              return Halogen_HTML_Elements.textarea([ Halogen_HTML_Properties.value(text), Halogen_HTML_Properties.prop(Halogen_HTML_Core.isPropString)("size")("100") ]);
          })();
          var numberOfItems = Data_Array.length(v.items_order);
          var moveButton = function (itemIx) {
              return Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title("\u2195"), Halogen_HTML_Events.onClick(function (v1) {
                  return new StartMovingItem(itemIx);
              }) ])([ Halogen_HTML_Core.text("\u2195") ]);
          };
          var itemInput = function (text) {
              return function (action) {
                  return Halogen_HTML_Elements.input([ Halogen_HTML_Properties.prop(Halogen_HTML_Core.isPropString)("size")("100"), Halogen_HTML_Properties.value(text), Halogen_HTML_Events.onValueInput(action) ]);
              };
          };
          ...
          var itemRow = function (v1) {
              var selectToggleButton = (function () {
                  var v2 = Data_Map_Internal.lookup(Data_Ord.ordInt)(v1.value1)(v.selectedItems);
                  if (v2 instanceof Data_Maybe.Nothing) {
                      return selectButton(v1.value1);
                  };
                  if (v2 instanceof Data_Maybe.Just) {
                      return deselectButton(v1.value1);
                  };
                  throw new Error("Failed pattern match at Main (line 161, column 12 - line 163, column 46): " + [ v2.constructor.name ]);
              })();
              var moveControl = (function () {
                  if (v.m_movingItemIx instanceof Data_Maybe.Nothing) {
                      return moveButton(v1.value0);
                  };
                  if (v.m_movingItemIx instanceof Data_Maybe.Just) {
                      if (v.m_movingItemIx.value0 === v1.value0) {
                  ...
                  throw new Error("Failed pattern match at Main (line 165, column 11 - line 169, column 40): " + [ v.m_movingItemIx.constructor.name ]);
              })();
          ...
          var selectedRow = function (itemId) {
              var selectedItemControls = (function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 177, column 12 - line 182, column 18): " + [ v1.constructor.name ]);
              })();
  ...
  var clearButton = Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title("CLEAR"), Halogen_HTML_Events.onClick(function (v1) {
          ...
          var clearOrUndoButton = (function () {
              if (v.m_backup instanceof Data_Maybe.Nothing) {
                  return clearButton;
              };
              if (v.m_backup instanceof Data_Maybe.Just) {
                  return undoButton;
              };
              throw new Error("Failed pattern match at Main (line 135, column 7 - line 137, column 29): " + [ v.m_backup.constructor.name ]);
          })();
          var addButton = Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title("new"), Halogen_HTML_Events.onClick(function (v1) {
              return AddItem.value;
          }) ])([ Halogen_HTML_Core.text("new") ]);
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("https://github.com/michalkonecny/feedbanq") ])([ Halogen_HTML_Core.text("source code on GitHub") ]), Halogen_HTML_Elements.table_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Item") ]) ]) ])(Data_Functor.map(Data_Functor.functorArray)(itemRow)(Data_Array.zip(Data_Array.range(0)(numberOfItems - 1 | 0))(v.items_order)))), addButton, clearOrUndoButton, (function () {
              var $55 = Data_Map_Internal.isEmpty(v.selectedItems);
              if ($55) {
                  return Halogen_HTML_Core.text("");
              };
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.table_(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Selected (reload tab to clear)") ]) ]) ])(Data_Functor.map(Data_Functor.functorArray)(selectedRow)(v.items_order))), result ]);
          })() ]);
      };
      var readLocalStorage = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          ...
          if (v.m_storage instanceof Data_Maybe.Just) {
              var parseItems = function (m_itemsS) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(m_itemsS)(function (itemsS) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Either.hush(Data_Argonaut_Decode_Parser.parseJson(itemsS)))(function (json) {
                          return Data_Either.hush(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeMap(Data_Ord.ordInt)(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.decodeJsonString)))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonInt)))(Data_Argonaut_Decode_Class.gDecodeJsonNil)({
                              reflectSymbol: function () {
                                  return "items_order";
                              }
                          })()())({
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Storage_Storage.getItem("items")(v.m_storage.value0)))(function (m_itemsS) {
                  var m_items = parseItems(m_itemsS);
                  if (m_items instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  };
                  if (m_items instanceof Data_Maybe.Just) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $64.items = m_items.value0.items;
                          $64.items_order = m_items.value0.items_order;
                          return $64;
                      });
                  };
                  throw new Error("Failed pattern match at Main (line 294, column 9 - line 297, column 73): " + [ m_items.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at Main (line 288, column 5 - line 303, column 33): " + [ v.m_storage.constructor.name ]);
      });
      var handleAction = function (v) {
          if (v instanceof Init) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.localStorage)))(function (storage) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $73.m_storage = new Data_Maybe.Just(storage);
                      return $73;
                  }))(function () {
          ...
          if (v instanceof AddItem) {
              var addItem = function (v1) {
                  var newItemId = 1 + Data_Maybe.maybe(0)(Control_Category.identity(Control_Category.categoryFn))(Data_Functor.map(Data_Maybe.functorMaybe)(function (v2) {
                      return v2.key;
                  ...
                  $77.items = items$prime;
                  $77.items_order = items_order$prime;
                  $77.m_backup = Data_Maybe.Nothing.value;
                  return $77;
              };
          ...
          if (v instanceof DeleteAllItems) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  return {
                      ...
                      m_backup: new Data_Maybe.Just({
                          items: s.items,
                          items_order: s.items_order
                      }),
                      items: initialState.items,
                      items_order: initialState.items_order,
                      m_movingItemIx: initialState.m_movingItemIx,
          ...
          if (v instanceof Undo) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  if (v1.m_backup instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  };
                  if (v1.m_backup instanceof Data_Maybe.Just) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          return {
                              m_storage: v1.m_storage,
                              items: v1.m_backup.value0.items,
                              items_order: v1.m_backup.value0.items_order,
                              m_backup: initialState.m_backup,
                              m_movingItemIx: initialState.m_movingItemIx,
                              selectedItems: initialState.selectedItems
                          };
                      }))(function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 214, column 7 - line 218, column 29): " + [ v1.m_backup.constructor.name ]);
              });
          };
          if (v instanceof UpdateItem) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $89.items = updateItem(s.items);
                  return $89;
              }))(function () {
                  return updateLocalStorage;
              });
          };
          if (v instanceof UpdateSelected) {
              var updateItem = function (items) {
                  return Data_Map_Internal.insert(Data_Ord.ordInt)(v.value0)(v.value1)(items);
              };
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $94.selectedItems = updateItem(s.selectedItems);
                  return $94;
              });
          };
          if (v instanceof SelectItem) {
              var selectItem = function (v1) {
                  var v2 = Data_Map_Internal.lookup(Data_Ord.ordInt)(v.value0)(v1.items);
                  if (v2 instanceof Data_Maybe.Just) {
                      return Data_Map_Internal.insert(Data_Ord.ordInt)(v.value0)(v2.value0)(v1.selectedItems);
                  };
                  if (v2 instanceof Data_Maybe.Nothing) {
                      return v1.selectedItems;
                  };
                  throw new Error("Failed pattern match at Main (line 235, column 9 - line 237, column 35): " + [ v2.constructor.name ]);
              };
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  var $104 = {};
                  for (var $105 in s) {
                  ...
                  $104.selectedItems = selectItem(s);
                  return $104;
              });
          };
          if (v instanceof DeselectItem) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $108.selectedItems = Data_Map_Internal["delete"](Data_Ord.ordInt)(v.value0)(s.selectedItems);
                  return $108;
              });
          };
          if (v instanceof StartMovingItem) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $112.m_movingItemIx = new Data_Maybe.Just(v.value0);
                  return $112;
              }))(function () {
                  return subscribeToKeys(Effect_Aff_Class.monadAffAff)(ProcessKey.create);
              });
          };
          if (v instanceof ProcessKey) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  if (v1.m_movingItemIx instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  };
                  if (v1.m_movingItemIx instanceof Data_Maybe.Just) {
                      var swap = function (i) {
                          return function (j) {
                              return function (order) {
                                  var m_order$prime = Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(order)(i))(function (item_i) {
                                      return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(order)(j))(function (item_j) {
                                          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.updateAt(i)(item_j)(order))(function (order1) {
                                              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.updateAt(j)(item_i)(order1))(function (order2) {
                                                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(order2);
                                              });
                                          });
                                      });
                                  });
                                  if (m_order$prime instanceof Data_Maybe.Nothing) {
                                      return order;
                                  };
                                  if (m_order$prime instanceof Data_Maybe.Just) {
                                      return m_order$prime.value0;
                                  };
                                  throw new Error("Failed pattern match at Main (line 265, column 13 - line 267, column 36): " + [ m_order$prime.constructor.name ]);
                              };
                          };
                      };
                      var moveItemTo = function (j) {
                          return function (v2) {
                              var v3 = 0 <= j && j < Data_Array.length(v2.items_order);
                              if (!v3) {
                                  return v2;
                              };
                              if (v3) {
                                  ...
                                  $123.items_order = swap(v1.m_movingItemIx.value0)(j)(v2.items_order);
                                  $123.m_movingItemIx = new Data_Maybe.Just(j);
                                  return $123;
                              };
                              throw new Error("Failed pattern match at Main (line 259, column 13 - line 263, column 46): " + [ v3.constructor.name ]);
                          };
                      };
                      if (v.value1 === "ArrowUp") {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $128.m_movingItemIx = Data_Maybe.Nothing.value;
                          return $128;
                      }))(function () {
                  ...
                  throw new Error("Failed pattern match at Main (line 247, column 7 - line 274, column 26): " + [ v1.m_movingItemIx.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at Main (line 184, column 18 - line 274, column 26): " + [ v.constructor.name ]);
      };
  ...
  exports["subscribeToKeys"] = subscribeToKeys;
})(PS);
PS["Main"].main();